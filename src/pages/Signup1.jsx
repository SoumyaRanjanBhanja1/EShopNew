    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-900 via-purple-900 to-slate-900 px-4">
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          {/* Optional: Role Selector for Admin/User */}
          <div>
            ...
            <select
              ...
              value={form.role}
              onChange={handleChange}
              className="w-full px-4 py-3 rounded-lg bg-white/5 border border-white/30 text-white focus:ring-2 focus:ring-indigo-400 outline-none"
            >
